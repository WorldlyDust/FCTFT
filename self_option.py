...
from packet.template import set_template
...
# Data specifications
parser.add_argument('--data_root', type=str, default='../data/NITRE2022_data', help='dataset directory')
...
opt.test_path = f"{opt.data_root}/Valid_Spectral/"

# opt.data_path = f"{opt.data_root}/cave_51_31/"
# opt.test_path = f"{opt.data_root}/cave_51_31_test/"
